<x-default-layout title="Dashboard" section_title="Dashboard">
    <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
        ...
        <div class="px-6 py-4 bg-green-50 border hover:border-l-4 border-green-400 space-y-1.5 shadow duration-200">
            <div class="text-zinc-600 text-sm flex justify-between items-center">
                <span>Total Majors</span>
                <!-- Link to majors -->
                <a href="{{ route('majors.index') }}" class="text-blue-600 text-sm underline hover:text-blue-800">Go to Majors</a>
            </div>
